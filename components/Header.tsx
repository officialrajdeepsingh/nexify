...
export function Header() {
  ...
  return (
    <header className="row-start-3 flex gap-6 pt-6 pb-4 flex-wrap items-center justify-center">
      <Link className={cn("flex items-center gap-2 hover:underline hover:underline-offset-4", segment === null && "underline underline-offset-4")} href="/">
      ...
      <Link className={cn("flex items-center gap-2 hover:underline hover:underline-offset-4", segment === "blog" && "underline underline-offset-4")} href="/blog">        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Link className={cn("flex items-center gap-2 hover:underline hover:underline-offset-4", segment === "about" && "underline underline-offset-4")} href="/about">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Link className={cn("flex items-center gap-2 hover:underline hover:underline-offset-4", segment === "contact" && "underline underline-offset-4")} href="/contact">
...
//  <Link className={segment === "blog" ? "flex items-center gap-2 bg-blue-50 underline underline-offset-4" : "flex items-center gap-2 hover:underline hover:underline-offset-4"} href="/blog">
